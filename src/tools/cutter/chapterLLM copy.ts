...
const schema: Schema = {
	...
	items: {
		description: "An array of opening sentences sorted by appearance. Each opening sentence indicates the exact start of each block of text",
		type: SchemaType.OBJECT,
		properties: {
			opening_words: {
description: `
It is a string that contains EXACTLY the first 5 initial opening words of the single text block.
